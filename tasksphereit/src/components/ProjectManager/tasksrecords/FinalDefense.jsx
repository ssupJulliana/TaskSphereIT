// src/components/ProjectManager/tasksrecords/FinalDefense.jsx
...
// Sample completed Final Defense tasks record. Edit/extend as needed.
const RAW_ROWS = [
  {
    no: 1,
...
export default function FinalDefense({ onBack }) {
