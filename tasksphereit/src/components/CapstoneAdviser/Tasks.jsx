...
const Toolbar = ({ onBack, onPage, page }) => (
  <div className="flex items-center gap-3 flex-wrap">
    ...
    <button className="inline-flex items-center gap-1 text-sm px-3 py-1.5 rounded-md border border-neutral-300 hover:bg-neutral-100">
  ...
  if (view === "detail" && category) {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="mt-3">
          {page === 1 ? (
            <Page1Table rows={PAGE1_ROWS} />
          ) : (
            <Page2Table rows={PAGE2_ROWS} />
          )}
        </div>
      </div>
    );
